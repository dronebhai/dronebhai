...
export interface DjiServiceEntry {
  model: string;         // model slug
  serviceType: string;    // serviceType slug
  pageTitle: string;
  heroHeadline: string;
  heroSubtitle: string;
  heroImageUrl: string;
  ...
  turnaround: string;
  symptoms: string[];
  serviceSteps: { step: string; description: string }[];
...
export const serviceTypes: ServiceType[] = [
  // Priority service types (full content)
  ...
  { slug: "camera-lens-service",          label: "Camera Lens Service",          icon: "camera" },
  { slug: "crash-damage-service",         label: "Crash Damage Service",         icon: "emergency_home" },
  ...
  { slug: "remote-controller-service",    label: "Remote Controller Service",    icon: "sports_esports" },
  { slug: "screen-display-service",       label: "Screen / Display Service",     icon: "monitor" },
  { slug: "frame-arm-service",            label: "Frame & Arm Service",          icon: "hardware" },
  { slug: "obstacle-sensor-service",      label: "Obstacle Sensor Service",      icon: "sensors" },
];

/* ============================================================
   SERVICE CONTENT ENTRIES (Priority Matrix — fully populated)
   ============================================================ */
const serviceEntries: DjiServiceEntry[] = [
  // ── Mini 4 Pro ──────────────────────────────────────────────
  {
    model: "mini-4-pro",
    serviceType: "gimbal-replacement",
    pageTitle: "DJI Mini 4 Pro Gimbal Replacement | Dronebhai",
    heroHeadline: "Mini 4 Pro Gimbal Replacement.",
    heroSubtitle: "Precision camera stabilisation service for your Mini 4 Pro. We restore perfect balance and clear vision to your drone.",
    ...
    faqs: [
      ...
      { q: "Is the gimbal covered under DJI Care?", a: "If you have an active DJI Care Refresh plan, gimbal replacement is typically included. Bring your Care plan details and we'll apply it to your service." },
  ...
  {
    model: "mini-4-pro",
    serviceType: "camera-lens-service",
    pageTitle: "DJI Mini 4 Pro Camera Lens Service | Dronebhai",
    heroHeadline: "Mini 4 Pro Camera Lens Service.",
    ...
    serviceSteps: [
      ...
      { step: "Image Quality Test", description: "Post-service test shots at multiple focal points to verify sharpness, colour accuracy, and absence of artefacts." },
    ],
    faqs: [
  ...
  {
    model: "mini-4-pro",
    serviceType: "crash-damage-service",
    pageTitle: "DJI Mini 4 Pro Crash Damage Service | Dronebhai",
    heroHeadline: "Mini 4 Pro Crash Damage Service.",
    heroSubtitle: "Comprehensive structural assessment and service after impact — from broken arms to full fuselage replacement.",
    heroImageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_G5TFJvlGZ45Qc02GyKNbTo_hrvSmpjL8noS7IDpytIy07D4N7__Dxmm5jhinRlEumzMgcecxinII8tLe5se5hJ0WmDK-csXofAjgjumgbHwjvubesFMwIC1PrkpyTHs_B-7GrslQTchIMlfoZb4-eYLFTMY-XO6WhVC93QpuS_d49Mb3lw2NZrrx5At9ftCo7Rf9uF-m8euoGor_dqm4mOX4WLA00FqQIIqfuzPJ7nIDknWvvg-5ow",
    ...
    faqs: [
      { q: "Will DJI Care Refresh cover my crash?", a: "If you have an active Care Refresh plan, crash services are covered for a reduced fee. Bring the drone and your Care details." },
      { q: "How do I get a service quote?", a: "Bring the drone in or WhatsApp us photos. We'll do a quick assessment and send a written quote within the same business day." },
    ],
  },
  ...
  // ── Mini 3 Pro ──────────────────────────────────────────────
  {
    ...
    heroImageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_G5TFJvlGZ45Qc02GyKNbTo_hrvSmpjL8noS7IDpytIy07D4N7__Dxmm5jhinRlEumzMgcecxinII8tLe5se5hJ0WmDK-csXofAjgjumgbHwjvubesFMwIC1PrkpyTHs_B-7GrslQTchIMlfoZb4-eYLFTMY-XO6WhVC93QpuS_d49Mb3lw2NZrrx5At9ftCo7Rf9uF-m8euoGor_dqm4mOX4WLA00FqQIIqfuzPJ7nIDknWvvg-5ow",
    heroImageAlt: "DJI Mini 3 Pro gimbal assembly on a clean white service bench under laboratory lighting.",
    ...
    faqs: [
      ...
      { q: "Can I service just one gimbal axis?", a: "In most cases a full gimbal unit replacement is more reliable and cost-effective than single-axis service." },
    ],
  },
  {
    model: "mini-3-pro",
  ...
  },
  {
    model: "mini-3-pro",
    serviceType: "camera-lens-service",
    pageTitle: "DJI Mini 3 Pro Camera Lens Service | Dronebhai",
    heroHeadline: "Mini 3 Pro Camera Lens Service.",
  ...
  },
  {
    model: "mini-3-pro",
    serviceType: "crash-damage-service",
    pageTitle: "DJI Mini 3 Pro Crash Damage Service | Dronebhai",
    heroHeadline: "Mini 3 Pro Crash Damage Service.",
    heroSubtitle: "Structural and electronic recovery after impact — comprehensive Mini 3 Pro crash service service.",
    heroImageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_G5TFJvlGZ45Qc02GyKNbTo_hrvSmpjL8noS7IDpytIy07D4N7__Dxmm5jhinRlEumzMgcecxinII8tLe5se5hJ0WmDK-csXofAjgjumgbHwjvubesFMwIC1PrkpyTHs_B-7GrslQTchIMlfoZb4-eYLFTMY-XO6WhVC93QpuS_d49Mb3lw2NZrrx5At9ftCo7Rf9uF-m8euoGor_dqm4mOX4WLA00FqQIIqfuzPJ7nIDknWvvg-5ow",
    ...
    faqs: [
      { q: "Can you service the Mini 3 Pro if the arm is broken off?", a: "Yes — in most cases a broken arm is serviceable. Bring it in and we'll assess whether it's a structural or full-frame replacement." },
    ],
  },
  ...
  },
  {
    model: "mavic-3",
    serviceType: "camera-lens-service",
    pageTitle: "DJI Mavic 3 Camera Lens Service | Dronebhai",
    heroHeadline: "Mavic 3 Camera Lens Service.",
    ...
    serviceSteps: [
      { step: "Optical Quality Scan",    description: "MTF (resolution) chart test before and after service for quality assurance." },
    ...
    faqs: [
      { q: "Does the tele camera also need separate lens service?", a: "Yes — the Mavic 3's 162mm telephoto has a separate optical assembly. We handle both cameras independently." },
    ],
  },
  {
    model: "mavic-3",
    serviceType: "crash-damage-service",
    pageTitle: "DJI Mavic 3 Crash Damage Service | Dronebhai",
    heroHeadline: "Mavic 3 Crash Damage Service.",
    heroSubtitle: "Complete structural and systems recovery for the Mavic 3 after impact.",
    heroImageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_G5TFJvlGZ45Qc02GyKNbTo_hrvSmpjL8noS7IDpytIy07D4N7__Dxmm5jhinRlEumzMgcecxinII8tLe5se5hJ0WmDK-csXofAjgjumgbHwjvubesFMwIC1PrkpyTHs_B-7GrslQTchIMlfoZb4-eYLFTMY-XO6WhVC93QpuS_d49Mb3lw2NZrrx5At9ftCo7Rf9uF-m8euoGor_dqm4mOX4WLA00FqQIIqfuzPJ7nIDknWvvg-5ow",
    heroImageAlt: "A DJI Mavic 3 with crash damage on a technician's workbench being assessed for service.",
    ...
    serviceSteps: [
      ...
      { step: "OEM Frame Service",    description: "Cracked arms or body panels replaced with genuine Mavic 3 structural parts." },
      { step: "Sensor Recalibration", description: "APAS vision sensors recalibrated post-service to factory flight safety standards." },
      { step: "Outdoor Flight Test", description: "Controlled outdoor hover and manoeuvre test to verify complete airworthiness." },
    ],
    faqs: [
      { q: "Is the Mavic 3 worth servicing after a severe crash?", a: "Usually yes — the Mavic 3 is a premium platform. We provide a full written assessment before you commit to any service cost." },
    ],
  },
  ...
  // ── Air 3 ────────────────────────────────────────────────────
  {
    ...
    heroImageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_G5TFJvlGZ45Qc02GyKNbTo_hrvSmpjL8noS7IDpytIy07D4N7__Dxmm5jhinRlEumzMgcecxinII8tLe5se5hJ0WmDK-csXofAjgjumgbHwjvubesFMwIC1PrkpyTHs_B-7GrslQTchIMlfoZb4-eYLFTMY-XO6WhVC93QpuS_d49Mb3lw2NZrrx5At9ftCo7Rf9uF-m8euoGor_dqm4mOX4WLA00FqQIIqfuzPJ7nIDknWvvg-5ow",
    heroImageAlt: "DJI Air 3 gimbal assembly on a bright clean service bench.",
    ...
    faqs: [
      { q: "Can just one of the two cameras be serviced?", a: "Yes — in some cases only one camera module is faulty. We can diagnose and service at camera level to reduce cost." },
    ],
  },
  {
    model: "air-3",
  ...
  },
  {
    model: "air-3",
    serviceType: "camera-lens-service",
    pageTitle: "DJI Air 3 Camera Lens Service | Dronebhai",
    heroHeadline: "Air 3 Camera Lens Service.",
    ...
    serviceSteps: [
      ...
      { step: "Resolution Verification",        description: "Resolution chart test on both cameras post-service." },
      { step: "Colour Accuracy Check",          description: "Colour calibration confirmed between wide and tele modules." },
    ],
    faqs: [
      { q: "Can you service just the tele lens without touching the wide?", a: "Yes — each camera module is independent. We service only the affected unit to keep costs minimal." },
    ],
  },
  {
    model: "air-3",
    serviceType: "crash-damage-service",
    pageTitle: "DJI Air 3 Crash Damage Service | Dronebhai",
    heroHeadline: "Air 3 Crash Damage Service.",
    heroSubtitle: "Full structural and electronic recovery for the DJI Air 3 after impact.",
    heroImageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_G5TFJvlGZ45Qc02GyKNbTo_hrvSmpjL8noS7IDpytIy07D4N7__Dxmm5jhinRlEumzMgcecxinII8tLe5se5hJ0WmDK-csXofAjgjumgbHwjvubesFMwIC1PrkpyTHs_B-7GrslQTchIMlfoZb4-eYLFTMY-XO6WhVC93QpuS_d49Mb3lw2NZrrx5At9ftCo7Rf9uF-m8euoGor_dqm4mOX4WLA00FqQIIqfuzPJ7nIDknWvvg-5ow",
    heroImageAlt: "A damaged DJI Air 3 on a service bench being assessed after a crash.",
    ...
    serviceSteps: [
      ...
      { step: "Frame & Motor Service", description: "Broken arms, motor mounts, and propeller drives replaced with OEM parts." },
      { step: "Sensor Recalibration", description: "All-direction APAS vision sensors re-calibrated after structural services." },
      { step: "Systems Flight Test",  description: "Test flight covering hover, forward flight, and obstacle avoidance." },
    ],
    faqs: [
      { q: "What if one camera is damaged and one is fine?", a: "We only replace the damaged camera assembly — the undamaged one is not disturbed. This keeps service cost proportional." },
    ],
  },
  ...
  // ── Air 2S ───────────────────────────────────────────────────
  {
    ...
    heroImageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_G5TFJvlGZ45Qc02GyKNbTo_hrvSmpjL8noS7IDpytIy07D4N7__Dxmm5jhinRlEumzMgcecxinII8tLe5se5hJ0WmDK-csXofAjgjumgbHwjvubesFMwIC1PrkpyTHs_B-7GrslQTchIMlfoZb4-eYLFTMY-XO6WhVC93QpuS_d49Mb3lw2NZrrx5At9ftCo7Rf9uF-m8euoGor_dqm4mOX4WLA00FqQIIqfuzPJ7nIDknWvvg-5ow",
    heroImageAlt: "DJI Air 2S 1-inch sensor gimbal assembly being inspected on a clean service bench.",
  ...
  },
  {
    model: "air-2s",
    serviceType: "camera-lens-service",
    pageTitle: "DJI Air 2S Camera Lens Service | Dronebhai",
    heroHeadline: "Air 2S Camera Lens Service.",
    ...
    faqs: [
      { q: "Is it worth servicing the Air 2S lens instead of buying new?", a: "Absolutely — the Air 2S's 1-inch sensor and F2.8–F11 aperture system is premium. A lens service at ₹4,500–7,500 is significantly less than a replacement body." },
    ],
  },
  {
    model: "air-2s",
    serviceType: "crash-damage-service",
    pageTitle: "DJI Air 2S Crash Damage Service | Dronebhai",
    heroHeadline: "Air 2S Crash Damage Service.",
    heroSubtitle: "Complete impact recovery for the DJI Air 2S — structural and electronic systems restored.",
    heroImageUrl: "https://lh3.googleusercontent.com/aida-public/AB6AXuA_G5TFJvlGZ45Qc02GyKNbTo_hrvSmpjL8noS7IDpytIy07D4N7__Dxmm5jhinRlEumzMgcecxinII8tLe5se5hJ0WmDK-csXofAjgjumgbHwjvubesFMwIC1PrkpyTHs_B-7GrslQTchIMlfoZb4-eYLFTMY-XO6WhVC93QpuS_d49Mb3lw2NZrrx5At9ftCo7Rf9uF-m8euoGor_dqm4mOX4WLA00FqQIIqfuzPJ7nIDknWvvg-5ow",
    heroImageAlt: "A DJI Air 2S with visible crash damage being assessed on a service bench.",
    ...
    serviceSteps: [
      { step: "Damage Scope Report",  description: "Itemised service quote provided after comprehensive teardown assessment." },
      { step: "Structural Service",    description: "Arm assemblies, motor housings, and shell components replaced." },
      { step: "IMU Recalibration",    description: "Inertial Measurement Unit re-calibrated on flat surface post-service." },
      { step: "Controlled Flight Test", description: "Indoor hover plus outdoor manoeuvre test before handover." },
    ],
    faqs: [
      { q: "My Air 2S won't turn on after a crash — is it serviceable?", a: "Usually yes. Power rail faults post-crash are common and serviceable. Bring it in for a no-charge initial assessment." },
    ],
  },
];
...
/* ============================================================
   ...
   All extended model × service-type combinations produce a valid
   page at build time. Content gracefully falls back to model/
   service-type label data if no full entry exists.
   ============================================================ */

// Build a lookup map for fast access
const serviceEntryMap = new Map<string, DjiServiceEntry>();
for (const entry of serviceEntries) {
  serviceEntryMap.set(`${entry.model}__${entry.serviceType}`, entry);
}

export function getServiceEntry(
  modelSlug: string,
  serviceTypeSlug: string
): DjiServiceEntry | null {
  return serviceEntryMap.get(`${modelSlug}__${serviceTypeSlug}`) ?? null;
}
...
export function getServiceTypeBySlug(slug: string): ServiceType | undefined {
  return serviceTypes.find((r) => r.slug === slug);
}

/** All model × serviceType pairs for generateStaticParams */
export function getAllServiceCombinations(): { model: string; serviceType: string }[] {
  const combinations: { model: string; serviceType: string }[] = [];
  for (const model of djiModels) {
    for (const rt of serviceTypes) {
      combinations.push({ model: model.slug, serviceType: rt.slug });
    }
  }
  return combinations;
}
